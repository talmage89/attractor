...
2. **Fix each issue.** For every bug across all findings files:
...
4. **Commit and push.** Commit your fixes and push to the remote. Use conventional commit messages.
5. **Update progress.** Append a section to `.attractor/workspace/progress.md` describing what you fixed:
   ...
   ```
6. **Delete all findings files.** The next test round will create fresh ones:
   ```
